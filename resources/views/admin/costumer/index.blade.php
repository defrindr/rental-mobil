            ...
            <div class="col-xs-12 col-lg-12 col-sm-12 col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive" id="table-content">
                                ...
                                @else
                                    ...
                                    @foreach ($costumers as $costumer)
                                        <tr>
                                            ...
                                            <td style="text-align:center;padding:3px">
                                                <form method="POST" action="{{ route('costumer_destroy',$costumer->id) }}">@csrf @method('DELETE')<button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></form>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
                        ...
                        {{ $costumers->links('admin.costumer.paginate') }}
                    </div>
                </div>
            </div>
        </div> <!-- /.row -->
